...
class DeviceDetailProvider {
  Future<List<DeviceInfoModel>> getDeviceList() async {
    List<DeviceInfoModel> devices = [
      DeviceInfoModel(1, DeviceCategory(DeviceCategoryType.AC, "Air Conditioner", ""), "", "assets/images/tv.png", "LG 101", 0, 12,
          airConditioner: AirConditioner(AirConditionerModes.COOL, 80, 24)),
      DeviceInfoModel(2, DeviceCategory(DeviceCategoryType.AC, "Air Conditioner", ""), "", "assets/images/tv.png", "VD 13", 0, 15,
